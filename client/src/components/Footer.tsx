        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Connect, learn, and grow with our community. Exchange skills and knowledge 
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/swap-requests" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Swap Requests
                </Link>
              </li>
            </ul>
